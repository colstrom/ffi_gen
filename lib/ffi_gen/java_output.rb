class FFIGen
  def generate_java
    writer = Writer.new "    ", " * ", "/**", " */"
    writer.puts "package #{@package};", "// Generated by ffi_gen. Please do not change this file by hand.", "import jnr.ffi.*;", "import jnr.ffi.util.*;", "import jnr.ffi.mapper.*;", "import java.lang.annotation.*;", "", "public class #{@module_name} {"
    writer.indent do
